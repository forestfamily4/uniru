                ...
                inputRef.current?.value === p.code ?
                    <>
                        ...
                        <PopupButton onClick={() => {
                            ...
                            className="text-green-900 hover:text-white border border-green-800 hover:bg-green-900 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-5 mt-5"
                            buttonName="結果を共有"
                        >
                            <>
